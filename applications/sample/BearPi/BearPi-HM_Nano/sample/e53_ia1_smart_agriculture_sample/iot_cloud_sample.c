...
#define CONFIG_WIFI_SSID          "P40"                                        //修改为自己的WiFi 热点账号
#define CONFIG_WIFI_PWD           "11111111"                                  //修改为自己的WiFi 热点密码

#define CONFIG_APP_SERVERIP       "117.78.5.125"                               //华为IoT平台IP
#define CONFIG_APP_SERVERPORT     "1883"                                        //华为IoT平台端口

#define CONFIG_APP_DEVICEID       "6a2a02a27f2e6c302f79c73e_lonemonk"         //替换为注册设备后生成的deviceid
#define CONFIG_APP_DEVICEPWD      "200412zg"                                   //替换为注册设备后生成的密钥
